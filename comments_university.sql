...
CREATE TABLE IF NOT EXISTS `course_teachers` ( -- courses_teachers, бо звязок багато до багато
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `degree` ( -- degrees
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `name` char(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `faculties` (
  ...
  `year` int(4) NOT NULL, -- э тип поля date->year
  `name_dekan` char(50) NOT NULL, -- не name, а звязок на таблицю teachers
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `group_courses` ( --groups_courses
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `teachers` (
  ...
  `date` char(50) NOT NULL, --що за char?
